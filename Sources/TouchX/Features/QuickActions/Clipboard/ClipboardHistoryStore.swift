...
/// A text-only history of pasteboard changes observed while TouchX is running.
///
...
/// One text value copied by the user after TouchX started observing the general pasteboard.
